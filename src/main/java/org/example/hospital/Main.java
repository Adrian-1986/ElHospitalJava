...
public class Main {
    public static void main(String[] args) {
        Patient consultation1 = new ConsultationPatient("Laura Perez", 28, "Allergy", "C-101");
        Patient consultation2 = new ConsultationPatient("Carlos Ruiz", 35, "Headache", "C-102");
        Patient ambulance1 = new AmbulancePatient("Maria Gomez", 42, "Fracture", "E-201", "Leg fracture");
        Patient ambulance2 = new AmbulancePatient("Jose Martinez", 50, "Trauma", "E-202", "Car accident");

        Doctor specialist1 = new SpecialistDoctor("Dr. Ana Lopez", 45, "LIC-1001",
                40, 20, "Cardiology");
        Doctor specialist2 = new SpecialistDoctor("Dr. Luis Herrera", 39, "LIC-1002",
                38, 18, "Neurology");
        Doctor student1 = new StudentDoctor("Dr. Sofia Diaz", 27, "LIC-2001",
                30, 15, "Internal Medicine I");
        Doctor student2 = new StudentDoctor("Dr. Pedro Silva", 26, "LIC-2002",
